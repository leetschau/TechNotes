Title: windows的自动登录和隐藏用户
Tags: 用户;windows7
Notebook: t[t/j/o/y/c]
Created: 2011-11-30 08:43:14
...
2. Check for the existence of a REG_SZ type entry called DefaultUserName. If exists, the value should be the user who you wish to logon automatically. If not exists, then right-click in the right pane, 新建->字符串值, name it "DefaultUserName". Set the string value to the required UserName. 
